...
<template>
    ...
    <div class="w-full min-h-screen flex flex-col gap-10 justify-center items-center">
        ...
        <form @submit.prevent="handleUpload" class="border-4 border-dashed border-slate-400 bg-gray-100 rounded-xl shadow p-10 flex flex-col gap-5 justify-center items-center mx-auto max-w-[600px] max-h-[500px] w-full h-full">
